...
struct The234234: Codable {
    ...
    let coverURL: String
    let year, price, dir, state: String
    let peopleIDS: [String]
    let duration, trackCount: Int
    let isUserLikes: Bool

    enum CodingKeys: String, CodingKey {
        case id, parent, name, cover
        case coverURL = "coverUrl"
        case year, price, dir, state
        case peopleIDS = "peopleIds"
        case duration, trackCount, isUserLikes
    }
}
...
// MARK: - The8
struct The8: Codable {
    let id, name, kzName, enName: String
    let haveChild: String
    let child: [JSONAny]
...
struct Person: Codable {
    let id, name, dir, typeName: String
    let productCount, productChildCount: String
    let genres: [String]
    ...
    enum CodingKeys: String, CodingKey {
        case id, name, dir, typeName, productCount, productChildCount, genres
        case coverFile = "cover_file"
        case coverURL = "coverUrl"
        case isUserLikes, description
    }
}
...
struct Track: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case year, price, dir, state
        case peopleIDS = "peopleIds"
        case duration, isUserLikes, lyrics2, hasLyrics
    }
}
...
struct Response: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case productChildIDS = "productChildIds"
    }
}
